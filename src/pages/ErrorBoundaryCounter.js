...
import { Reset, SVG, Count, Counter, Head, Body, Svgbtn } from '../styles/styles'
    ...
    <>
      ...
      <Body>
        ...
        <Counter>
          <Count>
            <Svgbtn theme={theme}>
              <SVG theme={theme} className={disable ? 'disable' : 'hover'} onClick={decrement} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
