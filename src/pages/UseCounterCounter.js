    ...
    <>
      ...
      <Body>
        ...
        <Counter>
          <Count>
            <Svgbtn theme={theme}>
              <SVG theme={theme} className={disableDecrement ? 'disable' : 'hover'} onClick={decrement} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
              </SVG>
            </Svgbtn>
            <div>{value}</div>
            <Svgbtn theme={theme}>
              <SVG theme={theme} onClick={increment} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="hover">
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
              </SVG>
            </Svgbtn>
          </Count>
          <Svgbtn theme={theme}>
            <Reset theme={theme} onClick={reset} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="hover">
