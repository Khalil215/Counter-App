    ...
    <>
      ...
      <Body>
        ...
        <Counter>
          <Count>
            <Svgbtn theme={theme} >
              <SVG theme={theme} className={disableDecrement ? 'disable' : 'hover'} onClick={() => dispatch({ type: 'DECREMENT' })} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
            ...
            <div>{value}</div>
            <Svgbtn theme={theme}>
              <SVG theme={theme} onClick={() => dispatch({ type: 'INCREMENT' })} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="hover">
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
              </SVG>
            </Svgbtn>
          </Count>
          <Svgbtn theme={theme}>
            <Reset theme={theme} onClick={() => dispatch({ type: 'RESET', state: Number(firstInput.current.value) })} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="hover">
        ...
        <div>
          <form onSubmit={handleSubmit}>
            ...
            <InputCont>
              ...
              <Input theme={theme} type="number" placeholder="0" ref={firstInput} />
            </InputCont>
            <InputCont>
              <label>Count by:</label>
              <Input theme={theme} type="number" placeholder="1" ref={secondInput} />
            </InputCont>
            <Button theme={theme}>Set</Button>
          </form>
        </div>
      </Body>
    </>
